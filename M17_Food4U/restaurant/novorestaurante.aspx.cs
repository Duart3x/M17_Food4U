...
{
    public partial class novorestaurante : System.Web.UI.Page
    {
        ...
        protected void btn_criarrestaurante_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int id_utilizador = int.Parse(Session["id_user"].ToString());
                ...
                int id_restaurant = restaurant.CriarRestaurante(id_utilizador);
