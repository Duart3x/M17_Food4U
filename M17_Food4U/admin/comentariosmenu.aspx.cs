...
{
    public partial class comentariosmenu : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request["id"] == null || !int.TryParse(Request["id"].ToString(), out int id_restaurante))
                Response.Redirect("~/index.aspx");
        ...
        protected void btn_eliminar_ServerClick(object sender, EventArgs e)
        {
            ...
            {*/
                ...
                if (id_comentario != null)
                {
                    ...
                    Models.MenuComment.DeleteComment(num_id_comentario);
                    AtualizarGrid();
                }
           /* }
            catch
