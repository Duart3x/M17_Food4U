<%@ Page Title="" Language="C#" MasterPageFile="~/master_page.Master" AutoEventWireup="true" CodeBehind="restaurante.aspx.cs" Inherits="M17_Food4U.restaurante" %>
    ...
    <div class="d-flex justify-content-between mt-5" id="page-detalhesmenu">
        <div class="w-50 mr-5" id="div_detalhesmenu">
            <div class="d-flex align-items-center">
                <h1 runat="server" id="restaurante_nome"></h1>
            </div>

            <img src="Public/images/restaurants/2.jpg" alt="" runat="server" class="img-thumbnail w-100 shadow mb-2" id="menu_foto" />
            <hr />
            <div class='menu_grid2 mt-4' id="menu_grid_menus" runat="server">
